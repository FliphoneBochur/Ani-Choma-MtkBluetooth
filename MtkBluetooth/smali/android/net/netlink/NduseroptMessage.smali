...
.method constructor <init>(Landroid/net/netlink/StructNlMsgHdr;Ljava/nio/ByteBuffer;)V
    ...
    iput-byte v0, p0, Landroid/net/netlink/NduseroptMessage;->family:B
    ...
    iput v0, p0, Landroid/net/netlink/NduseroptMessage;->opts_len:I
    ...
    iput v0, p0, Landroid/net/netlink/NduseroptMessage;->ifindex:I
    ...
    iput-byte v0, p0, Landroid/net/netlink/NduseroptMessage;->icmp_type:B
    ...
    iput-byte v0, p0, Landroid/net/netlink/NduseroptMessage;->icmp_code:B
    ...
    iput-object v1, p0, Landroid/net/netlink/NduseroptMessage;->option:Landroid/net/netlink/NdOption;
    :try_end_0
    ...
    .line 93
    iget v0, p0, Landroid/net/netlink/NduseroptMessage;->opts_len:I
    ...
    iget-short p2, p1, Landroid/net/netlink/StructNlAttr;->nla_type:S

    const/4 v0, 0x1

    if-ne p2, v0, :cond_1

    iget-object p2, p1, Landroid/net/netlink/StructNlAttr;->nla_value:[B

    if-eqz p2, :cond_1

    .line 103
    iget-byte p2, p0, Landroid/net/netlink/NduseroptMessage;->family:B
    ...
    iget-object p1, p1, Landroid/net/netlink/StructNlAttr;->nla_value:[B

    iget v0, p0, Landroid/net/netlink/NduseroptMessage;->ifindex:I

    invoke-static {p2, p1, v0}, Ljava/net/Inet6Address;->getByAddress(Ljava/lang/String;[BI)Ljava/net/Inet6Address;

    move-result-object p1

    iput-object p1, p0, Landroid/net/netlink/NduseroptMessage;->srcaddr:Ljava/net/InetAddress;
    ...
    const-string p2, "Invalid source address in ND useropt"
    ...
    const-string p2, "ND options extend past end of buffer"
